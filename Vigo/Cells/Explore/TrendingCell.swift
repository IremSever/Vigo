...
//                                                        //                                                              .aspectRatio(contentMode: .fill)
//                                                        
//                                                            .frame(width: selectedIndex == index ? (isExpanded ? 200 : 270) : 100, height: selectedIndex == index ? (isExpanded ? 250 : 350) : 150)
//                                                            .cornerRadius(20)
//                                                            .clipped()
//                                                            .overlay(
...
//                                                
//                                                .frame(
//                                                    width: selectedIndex == index ? 270 : 150,
//                                                    height: isExpanded ? 510 : 650,
//                                                    alignment: .center
//                                                )
//                                                
//                                                
